...
execute as @e[type=trident,tag=!amChanneling,nbt={inGround:1b}] at @s if data entity @s Item.tag.Enchantments.[{id:"minecraft:channeling",lvl:2s}] run function anc_me:channeling_2
