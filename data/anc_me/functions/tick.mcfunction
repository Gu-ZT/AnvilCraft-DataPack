...
execute as @e[type=item] at @s unless data entity @s Item.tag.Enchantments unless data entity @s Item.tag.StoredEnchantments run scoreboard players set @s amEnchCount 0
execute as @e[type=item] at @s if data entity @s Item.tag.Enchantments run function anc_me:tick/item_ench_count
execute as @e[type=item] at @s if data entity @s Item.tag.StoredEnchantments run function anc_me:tick/item_ench_count
