...
execute unless score @s ancDispenserSuccess matches 1 store success score @s ancDispenserSuccess if predicate anc:handle/feed run function anc:more/better_dispenser/type/feed
execute unless score @s ancDispenserSuccess matches 1 store success score @s ancDispenserSuccess if score #is_air ancValue matches 1 if block ~ ~ ~ dispenser{Items:[{Slot:0b,id:"minecraft:anvil"}]} run function anc:more/better_dispenser/type/anvil
execute unless score @s ancDispenserSuccess matches 1 store success score @s ancDispenserSuccess if score #is_air ancValue matches 1 if block ~ ~ ~ dispenser{Items:[{Slot:0b,id:"minecraft:chipped_anvil"}]} run function anc:more/better_dispenser/type/chipped_anvil
execute unless score @s ancDispenserSuccess matches 1 store success score @s ancDispenserSuccess if score #is_air ancValue matches 1 if block ~ ~ ~ dispenser{Items:[{Slot:0b,id:"minecraft:damaged_anvil"}]} run function anc:more/better_dispenser/type/damaged_anvil
