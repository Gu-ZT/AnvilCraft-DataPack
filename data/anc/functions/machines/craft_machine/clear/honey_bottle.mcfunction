...
execute store result storage anc:dist Item.Count byte 1 run data remove storage anc:temp Items[{id:"minecraft:honey_bottle"}]
function anc:machines/dist/machine
loot give @p loot anc:machines/craft_machine/items/glass_bottle
