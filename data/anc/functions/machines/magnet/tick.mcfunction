execute as @e[type=glow_item_frame,tag=anc_magnet] at @s if predicate anc:strong run function anc:machines/magnet/start
execute as @e[type=glow_item_frame,tag=anc_magnet] at @s unless predicate anc:strong run function anc:machines/magnet/stop
