...
execute if predicate anc:machines/interact_machine/glass_bottle store success score @s ancAbsorbSuccess if data block ~ ~ ~ Items.[{Slot:25b,tag:{ancClear:1b}}] if score @s ancExpValue matches 7.. run scoreboard players remove @s ancExpValue 7
