...
data remove storage anc:temp ancInteract
data modify storage anc:temp ancInteract set from block ~ ~ ~ Items[{Slot:1b}].tag.id
execute if data storage anc:temp {ancInteract:"anc:absorb_protocol"} run scoreboard players set @s ancInteract 1
execute if data storage anc:temp {ancInteract:"anc:repair_protocol"} run scoreboard players set @s ancInteract 2
execute if data storage anc:temp {ancInteract:"anc:protect_protocol"} run scoreboard players set @s ancInteract 3
execute if data storage anc:temp {ancInteract:"anc:restock_protocol"} run scoreboard players set @s ancInteract 4
execute if data storage anc:temp {ancInteract:"anc:placement_protocol"} run scoreboard players set @s ancInteract 5
