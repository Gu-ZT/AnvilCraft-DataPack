...
item replace block ~ ~ ~ container.0 with firework_star{ancClear:1b,display:{Name:'{"italic":false,"translate":"anc.block.craft_machine.name"}'},CustomModelData:11141013}
item replace block ~ ~ ~ container.2 with firework_star{ancClear:1b,display:{Name:'{"italic":false,"translate":"anc.block.craft_machine.name"}'},CustomModelData:11141000}
item replace block ~ ~ ~ container.6 with firework_star{ancClear:1b,display:{Name:'{"italic":false,"translate":"anc.block.craft_machine.name"}'},CustomModelData:11141000}
...
item replace block ~ ~ ~ container.10 with firework_star{ancClear:1b,display:{Name:'{"italic":false,"translate":"anc.block.craft_machine.name"}'},CustomModelData:11141000}
item replace block ~ ~ ~ container.11 with firework_star{ancClear:1b,display:{Name:'{"italic":false,"translate":"anc.block.craft_machine.name"}'},CustomModelData:11141000}
...
item replace block ~ ~ ~ container.20 with firework_star{ancClear:1b,display:{Name:'{"italic":false,"translate":"anc.block.craft_machine.name"}'},CustomModelData:11141000}
