...
scoreboard players set #exe_left ancValue 0
# 如果剩下可执行数，进行处理，注意每个物品都会kill
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:wheat"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
execute if score #Count ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:firework_star",tag:{CustomModelData:11140030,id:'anc:flour',display:{Name:'{"italic":false,"translate":"anc.item.flour.name"}'}}}
execute if score #Count ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #Count ancValue
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:iron_block"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:iron_ingot"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:gold_block"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:gold_ingot"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:copper_block"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:raw_iron_block"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:raw_gold_block"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:raw_copper_block"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:netherite_block"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:diamond_block"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:emerald_block"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:lapis_block"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:redstone_block"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:quartz_block"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:coal_block"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:glowstone"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:slime_block"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:melon"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:hay_block"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:bone_block"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:snow_block"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:clay"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:dried_kelp_block"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:nether_star"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:heart_of_the_sea"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:beef"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
...
# 如果有剩余材料，进行生成
execute if score #exe_left ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:porkchop"}
execute if score #exe_left ancValue matches 1.. store result storage temp input[-1].Count int 1 run scoreboard players get #exe_left ancValue
# 按照Count进行生成
execute if score #Count ancValue matches 1.. run data modify storage temp input append value {id:"minecraft:firework_star",tag:{CustomModelData:11140037,id:'anc:meat_stuffing',display:{Name:'{"italic":false,"translate":"anc.item.meat_stuffing.name"}'}}}
execute if score #Count ancValue matches 1.. store result storage temp input[-1].Count int 2 run scoreboard players get #Count ancValue
