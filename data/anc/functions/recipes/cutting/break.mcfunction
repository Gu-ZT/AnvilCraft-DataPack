...
execute if score #exe_count ancValue matches 1.. align xyz positioned ~.5 ~.5 ~.5 if entity @e[type=minecraft:item,predicate=anc:recipes/cutting,distance=..1] run function anc:recipes/cutting/loot
