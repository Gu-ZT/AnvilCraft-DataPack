...
execute positioned ~ ~-1 ~ as @e[type=minecraft:item,nbt={Item:{id:"minecraft:dispenser",Count:1b}},distance=..1] at @s run function anc:recipes/compressing/interact_machine_loot
