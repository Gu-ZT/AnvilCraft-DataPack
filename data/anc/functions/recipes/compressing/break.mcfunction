...
execute align xyz positioned ~.5 ~.5 ~.5 if block ~ ~ ~ #minecraft:cauldrons if entity @e[type=minecraft:item,predicate=anc:compressing,distance=..1] run function anc:recipes/compressing/loot
