...
# 菜鸟模式
    ...
    execute if score $ancRookieMode ancConfig matches 1 run scoreboard players set $max ancRandom 200
    # 生成随机数
...
# 菜鸟模式（关）
    ...
    execute unless score $ancRookieMode ancConfig matches 1 run scoreboard players set $max ancRandom 100
    # 生成随机数
