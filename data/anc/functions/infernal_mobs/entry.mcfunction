...
execute if score $output ancRandom matches ..20 run data modify storage anc:temp list append value '{"translate":"anc.infernal.dark","color":"red"}'
# 生锈
function anc:handle/random
...
execute if score $output ancRandom matches ..20 run data modify storage anc:temp list append value '{"translate":"anc.infernal.rust","color":"red"}'
# 粘性
function anc:handle/random
...
execute if score $output ancRandom matches ..20 run data modify storage anc:temp list append value '{"translate":"anc.infernal.sticky","color":"red"}'
# 织网
function anc:handle/random
...
execute if score $output ancRandom matches ..20 run data modify storage anc:temp list append value '{"translate":"anc.infernal.weaving_net","color":"red"}'